const GROUP_ACTIONS_CFG = {
    ...
    START_ROW: 2,
    TIMESTAMP_COL: 20, // T
    ACTIONS: ["IDLE", "Send to Archive", "Move to PhD", "Move to Custom OU", "Notify Deletion", "Notify Alumni", "Delete Account", "Restore", "Change Main Email"],
    COLORS: {
        "IDLE": "#fff9c4",
...
function executeGroupActions_(processAll) {
    ...
    let stats = { archive: 0, phd: 0, customOu: 0, notified: 0, deleted: 0, restored: 0, emailChanges: 0, errors: [] };
    ...
    if (stats.archive === 0 && stats.phd === 0 && stats.customOu === 0 && stats.notified === 0 && stats.deleted === 0 && stats.restored === 0 && stats.emailChanges === 0 && stats.errors.length === 0) {
